<template>
    <div class="container">
        <div class="row fixed-top px-5 py-4 d-flex justify-content-around align-items-center">
            <div class="col">
                <h3>
                    {{ namePage }}
                </h3>
        ...
        <div class="row mt-5 py-5 pt-5 title-center">
            <div class="col-12  align-items-center justify-content-center text-center">
                <h1>
                    Desafio para vaga de Analista Web
                </h1>
            </div>
        </div>
    </div>
